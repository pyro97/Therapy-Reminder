...
public class ModificaVisiteFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        modifica=view.findViewById(R.id.salvaVisita);
        rimuovi=view.findViewById(R.id.rimuoviVisita);

        titolo=view.findViewById(R.id.editTitolo);
        luogo=view.findViewById(R.id.editLuogo);
        giorno=view.findViewById(R.id.editGiorno);
        orario=view.findViewById(R.id.editOrario);
        medico=view.findViewById(R.id.editMedicoV);
