...
public class AggiungiMedicoFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view=inflater.inflate(R.layout.add_fragment_medico,container,false);
        aggiungi=view.findViewById(R.id.aggiungiMedico);
        nome=view.findViewById(R.id.addNome);
        cognome=view.findViewById(R.id.addCognome);
        via=view.findViewById(R.id.addVia);
        telefono=view.findViewById(R.id.addTelefono);
